  ...
  <div class="animated fadeIn">
    ...
    <div class="row">
      <div class="col-12">
          ...
          <router-link to="/jobs/create" class="btn btn-primary"> <i class="fa fa-star"></i>&nbsp; Create New</router-link>
        ...
        <b-card header="<i class='fa fa-align-justify'></i> Companies">
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="item in jobs_data" :key="item.id">
				<td>{{item.name}}</td>
                <td>
...
export default {
        ...
        methods: {        
            ...
            fetch(page) {
                ...
                axios.get('api/jobs?page='+page ).then((response) => {
                
                    this.jobs_data = response.data.data.data;
            ...
            destroy(id) {
                axios.post('api/jobs/delete/'+id ).then((response) => {                
                    ...
                    if(response.status == 200) {
                        this.jobs_data.splice(this.jobs_data.indexOf(id), 1);
