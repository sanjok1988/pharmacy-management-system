  ...
  <div class="animated fadeIn">
    ...
    <div class="row">
      <div class="col-12">
          ...
          <router-link to="/posts/create" class="btn btn-primary"> <i class="fa fa-star"></i>&nbsp; Create New</router-link>
		...
		<nav>
			<ul class="pagination">
				...
				<li v-for="page in pagesNumber" :key="page.value" v-bind:class="[ page == isActived ? 'active' : '']" class="page-item"> <a class="page-link" href="#" @click.prevent="changePage(page)">{{ page }}</a>
				</li>
            ...
            destroy(id) {
                axios.post('api/category/delete/'+id ).then((response) => {                
                    ...
                    if(response.status == 200) {
                        this.category_data.splice(this.category_data.indexOf(id), 1);
