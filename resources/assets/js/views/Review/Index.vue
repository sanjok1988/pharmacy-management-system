  ...
  <div class="animated fadeIn">
    ...
    <div class="row">
      <div class="col-12">
          ...
          <router-link to="/review/template/create" class="btn btn-primary"> <i class="fa fa-star"></i>&nbsp; Create New Template</router-link>
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="item in company_data" :key="item.id">
                ...
                <td>
                     <router-link :to="{ path: 'start/'+item.id}" class="btn btn-success"> <i class="fa fa-pencil"> Start Review</i></router-link>
...
export default {
        ...
        methods: {        
            ...
            fetch(page) {
                ...
                axios.get('api/template?page='+page ).then((response) => {
            ...
            destroy(id) {
                axios.post('api/template/delete/'+id ).then((response) => {                
