  ...
  <div class="animated fadeIn">
    ...
    <div class="row">
      <div class="col-12">
          ...
          <router-link to="/category/create" class="btn btn-primary"> <i class="fa fa-star"></i>&nbsp; Create New</router-link>
        ...
        <b-card header="<i class='fa fa-align-justify'></i> Users">
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="item in category_data" :key="item.id">
        ...
        methods: {
            ...
            fetch(page) {
                ...
                axios.get('api/category?page='+page ).then((response) => {
                    ...
                    this.category_data = response.data.data.data;
